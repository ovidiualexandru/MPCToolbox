function [h_disc_euler, h_disc_ode] = nonlinear_c2d(handle_nl_model)
%NONLINEAR_C2D Discretize nonlinear model
%   [handle_nl_model, handle_sl_model] = NONLINEAR_C2D(handle_nl_model) 
